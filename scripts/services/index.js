angular.module('timelineApp.services', [])
    .service('QiNiu', ['$rootScope', function ($rootScope) {
        ...
        var ak = 'e__WT-zBmjvT0_DpIgD3v8LF-PJty6aJoVLHXyVA',
            sk = 'pmOg4_EsDmQsZqHgozdPHOUpK7bdndvs-qi6kohB';
        var bucket = 'article';
        ...
        this.uploader = Qiniu.uploader({
            ...
            domain: 'http://7xt2kf.com1.z0.glb.clouddn.com/',   //bucket 域名，下载资源时用到，**必需**
